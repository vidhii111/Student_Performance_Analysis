...
- ![Absences vs grade](absences_vs_grade.png)
- ![Actual vs Prediction](actual_vs_prediction_grades.png)
- ![Avg Grade by Gender](avg_grade_by_gender_bar.png)
- ![Correction Matrix](correction_matrix.png)
- ![Failures vs Grade](failures_vs_grade.png)
- ![Final Grade Distribution](final_grade_distribution.png)
- ![Gender Distribution](gender_distribution_pie.png)
- ![Gender vs Final Grade](gender_vs_final_grade.png)
- ![Study Time vs Final Grade](study_time_vs_final_grade.png)
